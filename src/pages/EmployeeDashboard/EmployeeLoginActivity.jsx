...
import { fetchEmployeeLoginActivity } from "../../api/employeeAPIservice";
...
const EmployeeLoginActivity = ({ setActiveContent }) => {
  ...
  useEffect(() => {
    const loadData = async () => {
      setLoading(true);
      try {
        const result = await fetchEmployeeLoginActivity();
        if (result.success) {
          ...
          setemployeeProfile(result.data.trainee_profile);
    ...
    <div>
      ...
      {employeeProfile && (
        <div className="bg-white shadow-md rounded-lg p-6 mb-6">
          <h2 className="text-xl font-semibold mb-2">Employee Profile</h2>
          <p>
