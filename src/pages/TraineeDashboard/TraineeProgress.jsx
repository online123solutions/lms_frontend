...
import { getTraineeProgress } from "../../api/traineeAPIservice";
...
export default function TraineeProgress() {
  ...
  useEffect(() => {
    (async () => {
      try {
        const res = await getTraineeProgress(); // ensure endpoint is correct
        setData(res);
      } catch (e) {
  ...
  return (
    <div className="container trainee-progress">
