...
const AssessmentReport = () => {
  ...
  const traineeMarks = filteredReports.map((report) => report.trainee_score || 0);
  ...
  return (
    <div className="assessment-report" style={{ width: "100%", padding: "20px"}}>
              ...
              {examMarks.questions_feedback.map((q, index) => (
                ...
                >
                  ...
                  <p>
                    ...
                    >
                      {q.trainee_answer || (q.trainee_answer_image ? "" : "Not Answered")}
                    </span>
                  </p>
                  {q.trainee_answer_image && (
                    <img
                      src={q.trainee_answer_image}
                      alt="Your answer"
