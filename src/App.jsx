    ...
    const validateToken = async () => {
      ...
      if (token && storedAuth) {
        try {
          ...
          let validationUrl = `${API_BASE}/account/profile/`;

          // Try role-specific endpoints if available
          if (storedRole === 'trainee') {
            validationUrl = `${API_BASE}/trainee/profile/`;
          } else if (storedRole === 'trainer') {
            validationUrl = `${API_BASE}/trainer/profile/`;
            ...
            validationUrl = `${API_BASE}/account/profile/`;
          }
